#
#  Be sure to run `pod spec lint TTProgressView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "TTProgressView/TTProgressView", "TTProgressView/TTProgressView/**/*.{h,m,swift}"
